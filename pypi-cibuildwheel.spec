...
Version  : 2.10.2
Release  : 18
URL      : https://files.pythonhosted.org/packages/c2/56/b8a1635c54c194954bcc257f17373adf61d9ad6ab7489ba6d9a8f0299975/cibuildwheel-2.10.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/c2/56/b8a1635c54c194954bcc257f17373adf61d9ad6ab7489ba6d9a8f0299975/cibuildwheel-2.10.2.tar.gz
...
%prep
%setup -q -n cibuildwheel-2.10.2
cd %{_builddir}/cibuildwheel-2.10.2
pushd ..
cp -a cibuildwheel-2.10.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664205592
