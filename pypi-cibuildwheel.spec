...
Version  : 2.6.0
Release  : 6
URL      : https://files.pythonhosted.org/packages/88/dd/9b24e9e50006c2407b794f7634248790db726d9aff0b0f498be2aea105f5/cibuildwheel-2.6.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/88/dd/9b24e9e50006c2407b794f7634248790db726d9aff0b0f498be2aea105f5/cibuildwheel-2.6.0.tar.gz
...
%prep
%setup -q -n cibuildwheel-2.6.0
cd %{_builddir}/cibuildwheel-2.6.0
pushd ..
cp -a cibuildwheel-2.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653582091
