...
Version  : 2.16.2
Release  : 39
URL      : https://files.pythonhosted.org/packages/a2/28/9f04c550fe024087ef6ae69b731a136cd7add0b9858f689f1ea105d22966/cibuildwheel-2.16.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/a2/28/9f04c550fe024087ef6ae69b731a136cd7add0b9858f689f1ea105d22966/cibuildwheel-2.16.2.tar.gz
...
%prep
%setup -q -n cibuildwheel-2.16.2
cd %{_builddir}/cibuildwheel-2.16.2
pushd ..
cp -a cibuildwheel-2.16.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696430375
