...
Version  : 2.8.1
Release  : 12
URL      : https://files.pythonhosted.org/packages/38/cb/e51b06f669cf1270d8ff52b63a58fa70b728147520c18d5c5b1b7ae3b2e7/cibuildwheel-2.8.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/38/cb/e51b06f669cf1270d8ff52b63a58fa70b728147520c18d5c5b1b7ae3b2e7/cibuildwheel-2.8.1.tar.gz
...
%prep
%setup -q -n cibuildwheel-2.8.1
cd %{_builddir}/cibuildwheel-2.8.1
pushd ..
cp -a cibuildwheel-2.8.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658185824
