...
Version  : 2.8.0
Release  : 10
URL      : https://files.pythonhosted.org/packages/bf/9e/72971413a0555c999a8c78f5535e08a5ebd2fca265beebb5e3846a5d2c72/cibuildwheel-2.8.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/bf/9e/72971413a0555c999a8c78f5535e08a5ebd2fca265beebb5e3846a5d2c72/cibuildwheel-2.8.0.tar.gz
...
%prep
%setup -q -n cibuildwheel-2.8.0
cd %{_builddir}/cibuildwheel-2.8.0
pushd ..
cp -a cibuildwheel-2.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657053898
