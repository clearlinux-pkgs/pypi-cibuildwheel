...
Version  : 3.0.1
Release  : 56
URL      : https://files.pythonhosted.org/packages/f0/3f/4ebc40443fae990f850f0937eb51d99ca415c5450df8fdd89dc64e4ef0b2/cibuildwheel-3.0.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/f0/3f/4ebc40443fae990f850f0937eb51d99ca415c5450df8fdd89dc64e4ef0b2/cibuildwheel-3.0.1.tar.gz
...
%prep
%setup -q -n cibuildwheel-3.0.1
cd %{_builddir}/cibuildwheel-3.0.1
pushd ..
cp -a cibuildwheel-3.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1751901106
...
cp %{_builddir}/cibuildwheel-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-cibuildwheel/bfaff90fe643e9d1a86a9bc21aa23f09caa45847 || :
...
/usr/share/package-licenses/pypi-cibuildwheel/bfaff90fe643e9d1a86a9bc21aa23f09caa45847
