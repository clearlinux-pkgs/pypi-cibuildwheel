...
Version  : 2.6.1
Release  : 7
URL      : https://files.pythonhosted.org/packages/76/a5/51d59c6083235242fa2e9425efaf6f23c48fb7b05113a33dd415238748bb/cibuildwheel-2.6.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/76/a5/51d59c6083235242fa2e9425efaf6f23c48fb7b05113a33dd415238748bb/cibuildwheel-2.6.1.tar.gz
...
%prep
%setup -q -n cibuildwheel-2.6.1
cd %{_builddir}/cibuildwheel-2.6.1
pushd ..
cp -a cibuildwheel-2.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654611640
