...
Version  : 2.10.1
Release  : 17
URL      : https://files.pythonhosted.org/packages/25/fd/ef33f40a217c190faaee75486bd757131eaa73b0b72b9c904117f8653c17/cibuildwheel-2.10.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/25/fd/ef33f40a217c190faaee75486bd757131eaa73b0b72b9c904117f8653c17/cibuildwheel-2.10.1.tar.gz
...
%prep
%setup -q -n cibuildwheel-2.10.1
cd %{_builddir}/cibuildwheel-2.10.1
pushd ..
cp -a cibuildwheel-2.10.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663600033
