...
Version  : 2.10.0
Release  : 16
URL      : https://files.pythonhosted.org/packages/e4/8e/453a339fc0442e60652a297c020cfe9f8c2450033903ead37fa0472fcf13/cibuildwheel-2.10.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/e4/8e/453a339fc0442e60652a297c020cfe9f8c2450033903ead37fa0472fcf13/cibuildwheel-2.10.0.tar.gz
...
%prep
%setup -q -n cibuildwheel-2.10.0
cd %{_builddir}/cibuildwheel-2.10.0
pushd ..
cp -a cibuildwheel-2.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663080611
