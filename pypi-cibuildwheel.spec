...
Version  : 2.12.0
Release  : 28
URL      : https://files.pythonhosted.org/packages/f5/a7/ceaada4acfa5d91fc911cb851c094be7222f97950d974393d05b93f2d0bf/cibuildwheel-2.12.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/f5/a7/ceaada4acfa5d91fc911cb851c094be7222f97950d974393d05b93f2d0bf/cibuildwheel-2.12.0.tar.gz
...
%prep
%setup -q -n cibuildwheel-2.12.0
cd %{_builddir}/cibuildwheel-2.12.0
pushd ..
cp -a cibuildwheel-2.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673916524
