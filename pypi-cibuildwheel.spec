...
Source0  : https://files.pythonhosted.org/packages/3b/2e/844ef8e830fbcaddb8c879d1a43cecee155a36890d82b721406e48d6418d/cibuildwheel-2.17.0.tar.gz
...
%prep
%setup -q -n cibuildwheel-2.17.0
cd %{_builddir}/cibuildwheel-2.17.0
pushd ..
cp -a cibuildwheel-2.17.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710201655
