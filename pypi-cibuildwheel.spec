...
Version  : 2.19.2
Release  : 46
URL      : https://files.pythonhosted.org/packages/a3/8e/487c472a0f0f3661d5894bc01a8bd00306a81a4259090be94bd23617e004/cibuildwheel-2.19.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/a3/8e/487c472a0f0f3661d5894bc01a8bd00306a81a4259090be94bd23617e004/cibuildwheel-2.19.2.tar.gz
...
%prep
%setup -q -n cibuildwheel-2.19.2
cd %{_builddir}/cibuildwheel-2.19.2
pushd ..
cp -a cibuildwheel-2.19.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719945953
