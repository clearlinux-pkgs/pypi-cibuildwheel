...
Version  : 2.12.1
Release  : 29
URL      : https://files.pythonhosted.org/packages/c8/5a/c617e052f397106f6d9413cfe5652a09906a5e743562c5fb19c0242499d6/cibuildwheel-2.12.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/c8/5a/c617e052f397106f6d9413cfe5652a09906a5e743562c5fb19c0242499d6/cibuildwheel-2.12.1.tar.gz
...
%prep
%setup -q -n cibuildwheel-2.12.1
cd %{_builddir}/cibuildwheel-2.12.1
pushd ..
cp -a cibuildwheel-2.12.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1678719711
