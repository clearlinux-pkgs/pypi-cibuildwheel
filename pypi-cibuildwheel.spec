...
Version  : 2.5.0
Release  : 5
URL      : https://files.pythonhosted.org/packages/62/54/91f8d1dc5d21d22c7cf86646fb9e4af5edcfb5b299dfe4748d435edab6b1/cibuildwheel-2.5.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/62/54/91f8d1dc5d21d22c7cf86646fb9e4af5edcfb5b299dfe4748d435edab6b1/cibuildwheel-2.5.0.tar.gz
...
%prep
%setup -q -n cibuildwheel-2.5.0
cd %{_builddir}/cibuildwheel-2.5.0
pushd ..
cp -a cibuildwheel-2.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653009110
