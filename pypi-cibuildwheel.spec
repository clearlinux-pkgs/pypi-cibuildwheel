...
Version  : 2.18.0
Release  : 45
URL      : https://files.pythonhosted.org/packages/0e/ec/2a10ebf0a42009b569ad4dcca7a304fa510d4fc25a64005fbe89d529053f/cibuildwheel-2.18.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/0e/ec/2a10ebf0a42009b569ad4dcca7a304fa510d4fc25a64005fbe89d529053f/cibuildwheel-2.18.0.tar.gz
...
%prep
%setup -q -n cibuildwheel-2.18.0
cd %{_builddir}/cibuildwheel-2.18.0
pushd ..
cp -a cibuildwheel-2.18.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715619742
