...
Version  : 2.21.1
Release  : 47
URL      : https://files.pythonhosted.org/packages/5f/72/321af18bd00ad58260e0dbce67f29ba97d8eff61da00d3bf5e0fc9645153/cibuildwheel-2.21.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/5f/72/321af18bd00ad58260e0dbce67f29ba97d8eff61da00d3bf5e0fc9645153/cibuildwheel-2.21.1.tar.gz
...
%prep
%setup -q -n cibuildwheel-2.21.1
cd %{_builddir}/cibuildwheel-2.21.1
pushd ..
cp -a cibuildwheel-2.21.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726581784
